// FACTORY SIEGE - inline SVG icon library
...
const ICONS = {
  ...
  // Level 3: network nodes with breached link
  level3: `
  <svg viewBox="0 0 140 100" xmlns="http://www.w3.org/2000/svg">
    <g stroke="currentColor" stroke-width="2" fill="none" opacity="0.8">
      <line x1="30" y1="20" x2="70" y2="50"/>
      <line x1="110" y1="20" x2="70" y2="50"/>
      <line x1="30" y1="80" x2="70" y2="50"/>
    </g>
    <line x1="110" y1="80" x2="85" y2="60" stroke="var(--red)" stroke-width="2.5" stroke-dasharray="4 4"/>
    <circle cx="30" cy="20" r="8" fill="none" stroke="currentColor" stroke-width="2.5"/>
    <circle cx="110" cy="20" r="8" fill="none" stroke="currentColor" stroke-width="2.5"/>
    <circle cx="30" cy="80" r="8" fill="none" stroke="currentColor" stroke-width="2.5"/>
    <circle cx="70" cy="50" r="10" fill="currentColor" opacity="0.15" stroke="currentColor" stroke-width="2.5"/>
    <circle cx="110" cy="80" r="8" fill="none" stroke="var(--red)" stroke-width="2.5"/>
    <line x1="103" y1="73" x2="117" y2="87" stroke="var(--red)" stroke-width="2"/>
    <line x1="117" y1="73" x2="103" y2="87" stroke="var(--red)" stroke-width="2"/>
  </svg>`,

  // Level 4: relay / circuit chip
  level4: `
  <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg">
    <rect x="35" y="35" width="50" height="50" rx="4" fill="none" stroke="currentColor" stroke-width="3"/>
    <g stroke="currentColor" stroke-width="2.5">
      <line x1="35" y1="45" x2="15" y2="45"/>
      <line x1="35" y1="60" x2="15" y2="60"/>
      <line x1="35" y1="75" x2="15" y2="75"/>
      <line x1="85" y1="45" x2="105" y2="45"/>
      <line x1="85" y1="60" x2="105" y2="60"/>
      <line x1="85" y1="75" x2="105" y2="75"/>
      <line x1="45" y1="35" x2="45" y2="15"/>
      <line x1="60" y1="35" x2="60" y2="15"/>
      <line x1="75" y1="35" x2="75" y2="15"/>
      <line x1="45" y1="85" x2="45" y2="105"/>
      <line x1="60" y1="85" x2="60" y2="105"/>
      <line x1="75" y1="85" x2="75" y2="105"/>
    </g>
    <path d="M55 50 L64 50 L58 60 L67 60 L52 78 L57 63 L48 63 Z" fill="var(--amber)" stroke="none"/>
  </svg>`,

  // Level 5: master key / padlock, glowing
  level5: `
